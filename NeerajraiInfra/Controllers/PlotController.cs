...
namespace NeerajraiInfra.Controllers
{
    public class PlotController : AdminBaseController
    {
        ...
        public ActionResult ApprovePayment(string UserID, string Description, string ApprovedDate, bool CalculationChecked)
        {
            Plot model = new Plot();
            try
            {
        ...
        public ActionResult DeletePayment(string UserID)
        {
            Plot model = new Plot();
            try
            {
                ...
                DataSet ds = model.DeletePayment();
                if (ds != null && ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows[0][0].ToString() == "1")
                    {
        ...
        [HttpPost]
        [ActionName("IsKharijDakhil")]
        [OnAction(ButtonName = "Save")]
        public ActionResult IsKharijDakhilAction(Plot obj)
        {
            string FormName = "";
            string Controller = "";
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows[0][0].ToString() == "1")
                    {
                        TempData["Kharij"] = " Kharij Dakhil Done successfully !";
                    }
                    else
                    {
            ...
            {
                TempData["Kharij"] = ex.Message;
            }
            FormName = "IsKharijDakhil";
            Controller = "Plot";
        ...
        public ActionResult EVBooking(string PK_BookingId)
        {
            Plot model = new Plot();
            #region ddlBranch
            Plot obj = new Plot();
        ...
        [HttpPost]
        [ActionName("EVBooking")]
        [OnAction(ButtonName = "Save")]
        public ActionResult SaveEVBooking(Plot obj)
        {
            string FormName = "";
            string Controller = "";
            try
        ...
        public ActionResult UpdatePlot(string PK_BookingId)
        {
            Plot model = new Plot();
            #region ddlSite
            int count1 = 0;
        ...
        public ActionResult TransferPlot(Plot model)
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                if (ds.Tables[0].Rows[0]["Msg"].ToString() == "1")
                {
                    TempData["TransferPlotBooking"] = "Plot Updated !! ";
                }
                else if (ds.Tables[0].Rows[0]["Msg"].ToString() == "0")
                {
        ...
        public ActionResult ApproveInvestPayment(string UserID, string Description, string ApprovedDate)
        {
            string FormName = "";
            string Controller = "";
            try
            {
                ...
                model.AddedBy = Session["Pk_AdminId"].ToString();
                model.Result = "yes";
                DataSet ds = model.ApproveInvestmentPayment();
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    string msg = ds.Tables[0].Rows[0]["MSG"].ToString();
                   // string errorMessage = ds.Tables[0].Rows[0]["ErrorMessage"].ToString();
                    ...
                    if (msg == "1")
                    {
                        TempData["EVPayment"] = "Investment Payment Approved successfully!";
                    }
                    else
                    {
                ...
                {
                    TempData["EVPayment"] = "Unexpected error: No data returned from server.";
                }
            ...
            FormName = "ApprovInvestmentPayment";
            Controller = "Plot";
